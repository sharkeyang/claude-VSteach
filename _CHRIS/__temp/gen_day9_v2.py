# -*- coding: utf-8 -*-
"""生成 Chris 7/9 每日计划 Word 版（一页紧凑版：增加时长列 + 图标 + 备注区）"""
...
run(p, '──── 2026年7月9日 周四 · 第4天 ────', '微软雅黑', 9, NAVY)
...
out = r'D:\@VSwork\VSteach\_CHRIS\Chris每日计划20260709.docx'
doc.save(out)
print('SAVED:', out)
print('rows:', len(rows))
